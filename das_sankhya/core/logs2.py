...
from das_sankhya.middlewares.asgi_correlation_id.context import correlation_id, request_id
...
def set_log_extras(record):
    record["extra"]["datetime"] = pendulum.now("UTC")   # Log datetime in UTC time zone
